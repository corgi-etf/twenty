...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: 'b3c2e2c0-a32f-4f52-afc9-998f9cb18777', fieldMetadataUniversalIdentifier: MEETING_BOOKING_SCHEDULED_AT_FIELD_UNIVERSAL_IDENTIFIER, position: 3, isVisible: true },
    { universalIdentifier: 'ab6ada64-724b-4cae-b524-22c9294d2a96', fieldMetadataUniversalIdentifier: MEETING_BOOKING_STATUS_FIELD_UNIVERSAL_IDENTIFIER, position: 4, isVisible: true },
    { universalIdentifier: '1b43d0d8-7da6-47a8-93d3-8ba81fb8888e', fieldMetadataUniversalIdentifier: MEETING_BOOKING_VALIDATION_MESSAGE_FIELD_UNIVERSAL_IDENTIFIER, position: 5, isVisible: true },
    { universalIdentifier: 'de679b07-c241-44cc-aba0-6bda1279e7a2', fieldMetadataUniversalIdentifier: MEETING_BOOKING_BOOKED_AT_FIELD_UNIVERSAL_IDENTIFIER, position: 6, isVisible: true },
    { universalIdentifier: 'aa53504c-ce77-4b5f-be1d-dd2477ff8b0c', fieldMetadataUniversalIdentifier: BOOKED_BY_ON_MEETING_BOOKING_FIELD_UNIVERSAL_IDENTIFIER, position: 7, isVisible: true },
    { universalIdentifier: 'dc3a0327-036e-4fc7-ab50-ce3b069fa69f', fieldMetadataUniversalIdentifier: MEETING_BOOKING_NOTES_FIELD_UNIVERSAL_IDENTIFIER, position: 8, isVisible: true },
  ],
});
