...
export default defineView({
  ...
  fields: [
    ...
    { universalIdentifier: '1d68a61f-b171-4d50-994f-7be86934ea1e', fieldMetadataUniversalIdentifier: MEETING_BOOKING_ALLOCATION_REQUESTED_FIELD_UNIVERSAL_IDENTIFIER, position: 4, isVisible: true, size: 180 },
    { universalIdentifier: 'cd6586ff-a212-4090-a053-394efcb42981', fieldMetadataUniversalIdentifier: MEETING_BOOKING_SCHEDULED_AT_FIELD_UNIVERSAL_IDENTIFIER, position: 5, isVisible: true, size: 180 },
    { universalIdentifier: '505124bc-6c4d-47c3-a59e-ce53fd3b9f30', fieldMetadataUniversalIdentifier: MEETING_BOOKING_STATUS_FIELD_UNIVERSAL_IDENTIFIER, position: 6, isVisible: true, size: 140 },
    { universalIdentifier: '64222f5e-3b2c-4e5d-b35a-25b0a5285835', fieldMetadataUniversalIdentifier: MEETING_BOOKING_BOOKED_AT_FIELD_UNIVERSAL_IDENTIFIER, position: 7, isVisible: true, size: 180 },
    { universalIdentifier: 'f0032b31-c785-4c91-bed6-73670135571a', fieldMetadataUniversalIdentifier: BOOKED_BY_ON_MEETING_BOOKING_FIELD_UNIVERSAL_IDENTIFIER, position: 8, isVisible: true, size: 180 },
    { universalIdentifier: 'a5741ee6-3566-493a-b7b4-01bfb59510dc', fieldMetadataUniversalIdentifier: MEETING_BOOKING_VALIDATION_MESSAGE_FIELD_UNIVERSAL_IDENTIFIER, position: 9, isVisible: true, size: 260 },
  ],
});
